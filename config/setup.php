...
function runSetup(bool $forceReimport = false): array {
    ...
    $rawPdo->exec("CREATE DATABASE IF NOT EXISTS `fab_tcg` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;");
    $results[] = "Database `fab_tcg` created or verified.";
    ...
    // 4. Create starter / test user if no users exist
